/*
    Este relatório aborda o conceito de função em JavaScript, uma das características
    mais fundamentais e poderosas da linguagem de programação. Funções em JavaScript 
    são blocos de código que podem ser nomeados e reutilizados para executar uma 
    tarefa específica. Elas desempenham um papel crucial no desenvolvimento de
    aplicativos da web modernos,  permitindo modularidade, reutilização 
